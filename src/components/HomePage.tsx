...
const HomePage: React.FC<HomePageProps> = ({ onEntitySelect }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-saudi-green-600 to-saudi-green-700 rounded-lg p-8 text-white">
        <div className="max-w-4xl">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold">Saudi Observatory Dashboard</h1>
          </div>
          <p className="text-lg text-saudi-green-100 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              ...
              <p className="text-sm text-saudi-green-100">Complete coverage</p>
            </div>
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              <h3 className="font-semibold mb-1">120+ KPIs</h3>
              <p className="text-sm text-saudi-green-100">Real-time monitoring</p>
            </div>
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              <h3 className="font-semibold mb-1">4 Analytics Levels</h3>
              <p className="text-sm text-saudi-green-100">Maturity framework</p>
            </div>
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              <h3 className="font-semibold mb-1">AI-Powered</h3>
              <p className="text-sm text-saudi-green-100">Predictive insights</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Overall KPIs */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">System-wide Performance</h2>
            ...
            <div key={index} className="bg-white rounded-lg p-6 border border-gray-200">
              <div className="flex items-center justify-between mb-4">
                <div className={`w-12 h-12 ${kpi.bg} rounded-lg flex items-center justify-center`}>
                  <Activity className={`h-6 w-6 ${kpi.color}`} />
                </div>
                <span className={`px-2 py-1 text-sm font-medium ${kpi.color} ${kpi.bg} rounded-full`}>
                  {kpi.trend}
                </span>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Transport Mode Distribution</h3>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={transportModes}
      ...
      {/* Entity Performance */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Entity Performance Overview</h2>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-gray-900">{entity.score}</div>
              ...
              <div className="mb-4">
                <div className="flex flex-wrap gap-1 mb-2">
                  {entity.kpis.map((kpi, kpiIndex) => (
                    <span key={kpiIndex} className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">
                      {kpi}
                    </span>
                  ))}
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Analytics Maturity Distribution</h3>
          <ResponsiveContainer width="100%" height={300}>
        ...
        {/* Maturity Progress */}
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Maturity Level Progress</h3>
          <div className="space-y-4">
            {analyticsMaturity.map((level, index) => (
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-gray-900">{level.level}</span>
                  <span className="text-sm text-gray-600">{level.entities}/7 entities</span>
                </div>
                ...
                <div className="text-sm text-gray-500">{level.coverage}% coverage</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <button
            ...
            className="bg-white rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow text-left"
          >
            <div className="w-12 h-12 bg-saudi-green-100 rounded-lg flex items-center justify-center mb-4">
              <Brain className="h-6 w-6 text-saudi-green-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">Analytics Framework</h3>
            <p className="text-sm text-gray-600">Explore the 4-level maturity model</p>
          </button>
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900 mb-2">Descriptive Analytics</h3>
            <p className="text-sm text-gray-600">What happened? Real-time dashboards</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-600">What will happen? AI forecasting</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-600">What should we do? Automated decisions</p>
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">All 7 entities reporting normally</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Data refreshed every 5 minutes</p>
          </div>
          
          <div className="text-center">
            <div className="w-16 h-16 bg-saudi-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <Users className="h-8 w-8 text-saudi-green-600" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Active Monitoring</h3>
            <p className="text-gray-600">24/7 continuous surveillance</p>
          </div>
        </div>
      </div>
    </div>
